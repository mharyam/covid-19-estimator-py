...
def available_beds(total_hospital_beds):
    return float(0.35 * (total_hospital_beds))
...
def estimator(input_data):
    ...
    severe_cases_by_req_time_impact = float (0.15 * infections_by_requested_time_impact)
    hospital_beds_by_requested_time_impact = float((available_beds(total_hospital_beds) - severe_cases_by_req_time_impact))
    ...
    severe_cases_by_req_time_severe_impact = float(0.15 * infections_by_requested_time_severe_impact)
    hospital_beds_by_requested_time_severe_impact = float((available_beds(total_hospital_beds) - severe_cases_by_req_time_severe_impact))
